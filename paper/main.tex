...
\author{\IEEEauthorblockN{Valentin Lineiro}
\IEEEauthorblockA{\textit{TAKT Research Initiative} \\
...
\begin{IEEEkeywords}
Runtime Governance, Formal Verification, Decision Preservation, State Abstraction, Lean 4 Proof Assistant, Component Ablation.
\end{IEEEkeywords}
