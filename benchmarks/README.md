...
| **BENCHMARK-003** | How does temporal recalibration frequency affect long-term decision margin stability? | Recalibration horizon ($H$) | Temporal Drift & Recalibration | ST-016 / ST-017 | [`report.md`](BENCHMARK-003/report.md) | 📝 Pre-registered |
