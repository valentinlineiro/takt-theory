...
| **BENCHMARK-005** | How do multi-objective contracts interact under simultaneous drift, and do deadlocks emerge? | Contract count & priority | Multi-Contract Composition | ST-018 Disparador #2 | [`report.md`](BENCHMARK-005/report.md) | 📝 Pre-registered |
