...
| **BENCHMARK-004** | How do communication delays ($\tau_{\text{delay}}$) affect multi-node consensus safety and governance horizon guarantees? | Communication delay ($\tau_{\text{delay}}$) | Multi-Node Delay & Consensus | ST-018 Disparador #1 | [`report.md`](BENCHMARK-004/report.md) | 📝 Pre-registered |
