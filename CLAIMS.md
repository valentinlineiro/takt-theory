...
| **ST-016 Runtime Kernel Necessity** | `TaktFormal.RuntimeSufficiency`<br>`TaktFormal.RuntimeWitness` | `BENCHMARK-001`<br>`BENCHMARK-002`<br>`BENCHMARK-004` | [`BENCHMARK-001/artifact-policy-a.json`](file:///home/valentin/code/takt-theory/benchmarks/benchmark-001/artifact-policy-a.json)<br>[`BENCHMARK-002/artifact-dim-1000.json`](file:///home/valentin/code/takt-theory/benchmarks/benchmark-002/artifact-dim-1000.json)<br>[`BENCHMARK-004/artifact-delay-20.json`](file:///home/valentin/code/takt-theory/benchmarks/benchmark-004/artifact-delay-20.json) | **Verified Domain Validity** (v1.0-EXP + $|S|$ + $\tau_{\text{delay}}$ Robustness) | Asynchronous Byzantine consensus |
| **ST-017 Witness Transportability** | `TaktFormal.RuntimeTransportability` | `cli/src/st017-transportability` | `mockRuntime.ts` Witness | **Supported Core** (Phase III.1) | Cross-language Rust/Python transportability (Fase 4) |
| **G2 Governance Horizon** | `TaktFormal.DynamicSafetyContract` | `BENCHMARK-003`<br>`BENCHMARK-005` | [`BENCHMARK-003/artifact-horizon-20.json`](file:///home/valentin/code/takt-theory/benchmarks/benchmark-003/artifact-horizon-20.json)<br>[`BENCHMARK-005/artifact-conflict-stress.json`](file:///home/valentin/code/takt-theory/benchmarks/benchmark-005/artifact-conflict-stress.json) | **Verified Domain Validity** ($H_{\text{bound}}$ + Multi-Contract Determinism) | Dynamic contract negotiation under continuous drift |
