...
| **G2 Governance Horizon** | `TaktFormal.DynamicSafetyContract` | `benchmarks/batch-g2-001..004`<br>`benchmarks/benchmark-003` | [`BENCHMARK-003/artifact-horizon-20.json`](file:///home/valentin/code/takt-theory/benchmarks/benchmark-003/artifact-horizon-20.json) | **Empirically Exercised** ($H_{\text{bound}}$ Invariance) | Multi-contract dynamic composition |
