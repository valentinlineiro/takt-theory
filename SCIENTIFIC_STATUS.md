...
| **Replication & Verification Package** | **UNDER REVIEW** | Automated in `./scripts/verify.sh` | [`artifacts/verification/`](artifacts/verification/) | Closure Report & Replication Spec |
