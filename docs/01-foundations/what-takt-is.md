...
* **Sistema de Decisión y Operador $D$:** [DecisionSystem.lean](../../takt-formal/TaktFormal/DecisionSystem.lean)
* **Particiones y Kernel:** [Kernel.lean](../../takt-formal/TaktFormal/Kernel.lean)
* **Teorema de Factorización:** [Factorization.lean](../../takt-formal/TaktFormal/Factorization.lean)
* **Regret y Cota de Seguridad:** [Regret.lean](../../takt-formal/TaktFormal/Regret.lean)
* **Teorema de Equivalencia de Seguridad:** [SafetyEquivalence.lean](../../takt-formal/TaktFormal/SafetyEquivalence.lean)
* **Contraejemplo de Asimetría ($\varepsilon_U \not\implies \varepsilon_D$):** [EpsilonUCounterexample.lean](../../takt-formal/TaktFormal/EpsilonUCounterexample.lean)
