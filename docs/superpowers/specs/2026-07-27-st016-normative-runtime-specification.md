...
| :--- | :--- | :--- | :--- | :--- |
| **ContractSoundness** ($C_{\text{contract}}$) | Verification of domain invariants & contract safety | [`ContractEvaluator.ts`](file:///home/valentin/code/takt-theory/cli/src/runtime/ContractEvaluator.ts) | [`RuntimeSufficiency.lean`](file:///home/valentin/code/takt-theory/takt-formal/TaktFormal/RuntimeSufficiency.lean) | [`contract.ablation.test.ts`](file:///home/valentin/code/takt-theory/cli/src/runtime/__tests__/ablation/contract.ablation.test.ts) |
| **UncertaintyBound** ($C_{\text{uncertainty}}$) | Dynamic margin estimation ($M_D \approx 0$) under ambiguity | [`RobustMarginEstimator.ts`](file:///home/valentin/code/takt-theory/cli/src/runtime/RobustMarginEstimator.ts) | [`RuntimeSufficiency.lean`](file:///home/valentin/code/takt-theory/takt-formal/TaktFormal/RuntimeSufficiency.lean) | [`uncertainty.ablation.test.ts`](file:///home/valentin/code/takt-theory/cli/src/runtime/__tests__/ablation/uncertainty.ablation.test.ts) |
| **TemporalConsistency** ($C_{\text{temporal}}$) | History-dependent trajectory monitoring ($\tau = (R_0, \dots, R_t)$) | [`TrajectoryMonitor.ts`](file:///home/valentin/code/takt-theory/cli/src/runtime/TrajectoryMonitor.ts) | [`RuntimeSufficiency.lean`](file:///home/valentin/code/takt-theory/takt-formal/TaktFormal/RuntimeSufficiency.lean) | [`temporal.ablation.test.ts`](file:///home/valentin/code/takt-theory/cli/src/runtime/__tests__/ablation/temporal.ablation.test.ts) |
