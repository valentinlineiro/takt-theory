...
- [ ] **Step 3: Write minimal implementation**
  ...
  Create `cli/src/batch-003/evaluate.ts` to read the blind predictions from `research/data/batch-003/blind-predictions.jsonl` (to be created), compute OIA, absolute regret, NR, DOR, FCA, and write output to `research/analysis/batch-003.md`.
