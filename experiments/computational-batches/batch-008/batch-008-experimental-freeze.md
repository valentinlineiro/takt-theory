...
See `experiments/computational-batches/batch-008/batch-008-question-freeze.md` and `experiments/computational-batches/batch-008/batch-008-design-v1.0.md`. Key parameters:
